...
if(isset($_POST['insert_product'])){
    ...
    //accesing images tmp name
    $temp_image1=$_FILES['product_image1']['tmp_name'];
    //$temp_image2=$_POST['product_image2']['tmp_name'];
    //$temp_image3=$_POST['product_image3']['tmp_name'];

    //checking empty condition
    if($product_title=='' or $description=='' or $product_keywords=='' or $product_categories=='' or $product_brands=='' or $product_price=='' or  $product_image1==''){
        ...
        //insert query
        $insert_products="insert into products (product_title,product_description,product_keywords,category_id,brand_id,product_price,
        product_image1,date,status) values ('$product_title','$description','$product_keywords','$product_categories','$product_brands','$product_price','$product_image1',NOW(),'$product_status')";
